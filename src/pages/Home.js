      ...
      <div className="home__description row">
        <div className="description__text col-lg-6 ">
          ...
          <p className="mt-4">
            ...
            communication, de la création et du marketing, du design et des arts
            graphique ainsi que de l’ingénierie informatique.
            <br />
            <br />
            Les entreprises et les particuliers rencontrent souvent des
            problèmes lors du développement des projets par manque d’effectif ou
            de professionnels d’un domaine précis, Handelp sera là pour vous
            aider à trouver la personne idéale qui saura mettre au point votre
            idée ou projet grâce à son large carnet d’adresses et de contacts.
            <br />
            <br />
